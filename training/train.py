...
def main():
    ...
    with mlflow.start_run():
        try:
            ...
            # Extraire le modèle PyTorch
            torch_model = model.model  # modèle interne de YOLOv5

            # Sauvegarde avec Pickle
            with open("yolov5_model.pkl", "wb") as f:
              pickle.dump(torch_model, f)

            # Log dans MLflow
            mlflow.log_artifact("yolov5_model.pkl")
            print("✅ Modèle Pickle sauvegardé et loggé dans MLflow")
